...
3. If possible, reference relevant Google Play Asset Delivery documentation
...
4. Test in Unity Editor and on an Android device
...
2. Add to your Unity project via `Packages/manifest.json`:
   ```json
   "com.bizsim.google.play.assetdelivery": "file:../path/to/this/repo"
   ```
...
- Test on both Unity Editor (mock) and an Android device
